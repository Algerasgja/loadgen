...
pub type BranchProbTable = HashMap<FuncId, Vec<(FuncId, f64)>>;

pub fn generate_branch_prob_table(repo: &DagRepository, workflow_id: &WorkflowId, seed: u64) -> BranchProbTable {
    let mut rng = rand::SeedableRng::seed_from_u64(seed);
    let mut table: BranchProbTable = HashMap::new();
